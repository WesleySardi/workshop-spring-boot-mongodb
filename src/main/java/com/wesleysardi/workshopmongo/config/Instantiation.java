package com.wesleysardi.workshopmongo.config;

import com.wesleysardi.workshopmongo.domain.Post;
import com.wesleysardi.workshopmongo.domain.User;
import com.wesleysardi.workshopmongo.dto.AuthorDTO;
import com.wesleysardi.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post2 = new Post(null, sdf.parse("21/03/2018"),"Bom dia","Acorder feliz hoje!", new AuthorDTO(maria));
